...
execute "sed -i '/mysql/{n;n;n;n;s/'\\''DB_DATABASE'\\'', '\\''.*'\\''/'\\''DB_HOST'\\'', '\\''172.28.128.100'\\''/g}' /var/www/myProject/config/database.php"
...
execute "sed -i 's/DB_HOST=.*/DB_HOST=172.28.128.100/' /var/www/myProject/.env"
execute "sed -i 's/DB_DATABASE=.*/DB_DATABASE=myproject/' /var/www/myProject/.env"
execute "sed -i 's/DB_USERNAME=.*/DB_USERNAME=myproject/' /var/www/myProject/.env"
execute "sed -i 's/DB_PASSWORD=.*/DB_PASSWORD=mypassword/' /var/www/myProject/.env"

execute "cat /vagrant/route.php >> /var/www/myProject/routes/web.php"
